      ...
      <div className="profile-container" style={{ flex: 1, overflowY: "auto" }}>
        ...
        {!editMode && (
          ...
          >
            ...
            >
              <MdEdit size={16} />
              {t("pages.profile.editProfile") || "Edit Profile"}
            </button>
          </div>
        )}
        ...
        {editMode && (
          ...
          >
            ...
            <div style={{ marginBottom: "14px" }}>
              ...
              >
                {t("pages.profile.fullName") || "Full Name"}
              </label>
              <input
                type="text"
        ...
        {!passwordMode && (
          ...
          >
            ...
            {t("pages.profile.changePassword") || "Change Password"}
          </button>
        )}
        ...
        {passwordMode && (
          ...
          >
            ...
            <div style={{ marginBottom: "14px" }}>
              ...
              >
                {t("pages.profile.oldPassword") || "Current Password"}
              </label>
              <input
                type="password"
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              >
                {t("pages.profile.confirmPassword") || "Confirm Password"}
              </label>
              <input
                type="password"
