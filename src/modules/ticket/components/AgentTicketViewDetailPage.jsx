...
export default function AgentTicketViewDetailPage() {
  ...
  const refreshTicketData = async () => {
    ...
    await Promise.all([
      queryClient.refetchQueries({ queryKey: ["all-tickets"], type: "active" }),
              ...
              <div>
                {ticket?.status === "Progress" && isAssignedToMe && (
                  ...
                  >
                    ...
                    {resolvingTicket
                      ? t("pages.agentTicketDetail.resolving")
                      : t("pages.agentTicketDetail.markResolved")}
                  </button>
                )}
              ...
              {isLoading ? (
                ...
                >
                  ...
                  <div style={{ padding: "12px 6px" }}>
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          {t("pages.agentTicketDetail.priority")}
                        </div>
                        <div
                          style={{
                      ...
                      <div>
                        ...
                        >
                          {t("pages.agentTicketDetail.customer")}
                        </div>
                        <div
                          style={{
                            color: "#333",
                      ...
                      <div>
                        ...
                        >
                          {t("pages.agentTicketDetail.assignedTo")}
                        </div>
                        <div style={{ color: "#333" }}>
                          {ticket.solver ??
                            t("pages.agentTicketDetail.unassigned")}
                        </div>
                      </div>
                      <div>
                        <div
                    ...
                    >
                      ...
                      {!isAssignedToMe && !isResolvedStatus(ticket.status) && (
                        ...
                        >
                          {t(
                            "pages.agentTicketDetail.notAssigned",
                      ...
                      <form onSubmit={handleSubmitResponse}>
                        <textarea
                          ...
                          style={{
                            ...
                            background: isAssignedToMe ? "white" : "#f9fafb",
                            cursor: isAssignedToMe ? "text" : "not-allowed",
                  ...
                  {showDispatchPanel && isAssignedToMe && !resolved ? (
                    ...
                    >
                      ...
                      <div style={{ marginBottom: "16px" }}>
                        ...
                        <input
                          type="text"
                          placeholder={t(
                            "pages.agentTicketDetail.searchPlaceholder",
                          )}
                      ...
                      {selectedTechnician && (
                        ...
                        >
                          {[
                            {
                              label: t("pages.agentTicketDetail.techName"),
                              value: selectedTechnician.name,
                            },
                            {
                              label: t("pages.agentTicketDetail.techPosition"),
                              value: selectedTechnician.position ?? "-",
                            },
                            {
                              label: t("pages.agentTicketDetail.techEmail"),
                              value: selectedTechnician.email,
                            },
                            {
                              label: t("pages.agentTicketDetail.techSkills"),
                              value: formatTechnicianSkills(
                      ...
                      <div style={{ display: "flex", gap: "10px" }}>
                        ...
                        <button
                          ...
                          style={{
                            ...
                            border: "none",
                            background:
                              !selectedTechnician || dispatchingTech
                                ? "#ccc"
                                : "#FF8040",
                            color: "white",
                            fontWeight: "600",
                        ...
                        >
                          {dispatchingTech
                            ? t("pages.agentTicketDetail.dispatching")
                            : t("pages.agentTicketDetail.dispatch")}
                        </button>
                      </div>
                    </div>
                    ...
                    <div
                      className="agent-detail-right-col"
                      style={{
                        background: "#fffdfb",
                        borderRadius: "14px",
                        padding: "22px",
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        >
                                          {ticket?.customer ||
                                            t(
                                              "pages.agentTicketDetail.customer",
                                            )}
                                        </div>
                                        <div
                                          style={{
                                      ...
                                      >
                                        {t(
                                          "pages.agentTicketDetail.ticketCreated",
                                        )}
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        >
                                          {t(
                                            "pages.agentTicketDetail.ticketResolved",
                                          )}
                                        </div>
                                        <div
                                          style={{
                                      ...
                                      >
                                        {t(
                                          "pages.agentTicketDetail.statusSolved",
                                        )}
                                      </div>
                                    </div>
                                  </div>
                                    ...
                                    {commentAttachments.length > 0 && (
                                      <div
                                        style={{
                                          marginTop: "8px",
                                          paddingTop: "8px",
                                          borderTop: `1px solid ${isAgentReply ? "rgba(255,255,255,0.3)" : "#fde4d4"}`,
                                          display: "flex",
                                          flexDirection: "column",
                                          gap: "6px",
                                        }}
                                          ...
                                          >
                                            ...
                                            <div style={{ minWidth: 0 }}>
                                              ...
                                              >
                                                {downloadingId === file.id
                                                  ? t(
                                                      "pages.ticketDetail.loading",
                                                    )
                                                  : t(
                                                      "pages.ticketDetail.clickToView",
                                                    )}
                                              </div>
                                            </div>
                                          </button>
